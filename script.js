/** 
  ...
  1. Add 'display: none' to '#overlay' - we want to hide it initially.
  2. Use document.getElementById to target "open-modal"
  3. Add an event listener of "click"
  4. Use document.getElementById to target "overlay" and change the style.display to "block"
**/
